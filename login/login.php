...
<body style="background-color: #F0EBE3">
                ...
                <div>
                    <?php if (isset($_SESSION['usuario'])) { ?>
                        <form action="logout.php">
                            <button class="btn btn-danger" type="submit" value="<?php echo $_SESSION['usuario']; ?> - Sair">Logout</button>
                        </form>
                    <?php } else { ?>
                        <form action="#">
    ...
    <div class="container" style="margin-top: 70px; margin-left: 390px">
        <div>
            <div>
                <h3 style="margin-left: 40px">Faça o Login para Cadastrar um Anuncio!</h3>
                <form action="validar.php">
                    ...
                    <div class="col-7">
                        <label class="form-label" for="pswSenha">Senha</label>
                        <input class="form-control" type="password" id="pswSenha" name="pswSenha" placeholder="Senha" />
                    </div>
